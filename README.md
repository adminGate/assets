...
[![Latest Version](https://img.shields.io/github/release/admingate/laravel-assets.svg?style=flat-square)](https://github.com/admingate/laravel-assets/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Quality Score](https://img.shields.io/scrutinizer/g/admingate/laravel-assets.svg?style=flat-square)](https://scrutinizer-ci.com/g/admingate/laravel-assets)
[![StyleCI](https://styleci.io/repos/154250020/shield)](https://styleci.io/repos/154250020)
[![Total Downloads](https://img.shields.io/packagist/dt/admingate/assets.svg?style=flat-square)](https://packagist.org/packages/admingate/assets)
[![Maintainability](https://api.codeclimate.com/v1/badges/a6e4612307e3b3bf8252/maintainability)](https://codeclimate.com/github/admingate/laravel-assets/maintainability)

## Installation

```bash
composer require admingate/assets
```
...
'providers' => [
    ...
    Admingate\Assets\Providers\AssetsServiceProvider::class,
];
```
...
'aliases' => [
    ...
    'Assets' => Admingate\Assets\Facades\AssetsFacade::class,
];
```
...
```bash
php artisan vendor:publish --provider="Admingate\Assets\Providers\AssetsServiceProvider" --tag=config
```
